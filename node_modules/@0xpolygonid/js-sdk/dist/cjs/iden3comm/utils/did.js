...
exports.extractPublicKeyBytes = exports.resolveVerificationMethods = exports.resolveDIDDocument = void 0;
const constants_1 = require("../constants");
const elliptic_1 = __importDefault(require("elliptic"));
const kms_1 = require("../../kms");
const utils_1 = require("../../utils");
const resolveDIDDocument = async (didUrl, 
// eslint-disable-next-line @typescript-eslint/no-unused-vars
options) => {
    try {
        const response = await fetch(`${constants_1.UNIVERSAL_RESOLVER_URL}/${didUrl}`);
