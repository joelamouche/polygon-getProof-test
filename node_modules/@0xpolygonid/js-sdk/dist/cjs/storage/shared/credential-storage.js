...
class CredentialStorage {
    ...
    async listCredentials() {
        ...
        creds = creds.map((cred) => (cred ? Object.assign(new verifiable_1.W3CCredential(), cred) : undefined));
        return creds;
    }
    /** @inheritdoc */
    ...
    async findCredentialById(id) {
        ...
        return cred ? Object.assign(new verifiable_1.W3CCredential(), cred) : undefined;
    }
    /** {@inheritdoc ICredentialStorage.listCredentials }
     * uses JSON query
     */
