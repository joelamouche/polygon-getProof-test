...
import { W3CCredential, ProofQuery, SubjectPosition, MerklizedRootPosition, CredentialStatus, RevocationStatus, CredentialStatusType, IssuerData } from './../verifiable';
...
export interface ICredentialWallet {
     ...
     * @returns `Promise<RevocationStatus>`
     */
    getRevocationStatus(credStatus: CredentialStatus, issuerDID: DID, issuerData: IssuerData): Promise<RevocationStatus>;
    /**
...
export declare class CredentialWallet implements ICredentialWallet {
     ...
     */
    constructor(_storage: IDataStorage, _credentialStatusResolverRegistry?: CredentialStatusResolverRegistry);
    /**
