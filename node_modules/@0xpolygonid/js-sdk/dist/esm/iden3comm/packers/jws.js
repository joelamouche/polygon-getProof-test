...
import { extractPublicKeyBytes, resolveVerificationMethods, resolveDIDDocument } from '../utils/did';
...
export class JWSPacker {
     ...
     * @memberof JWSPacker
     */
    constructor(_kms, _documentResolver = { resolve: resolveDIDDocument }) {
        this._kms = _kms;
