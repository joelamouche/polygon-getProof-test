...
export class AtomicQuerySigV2Inputs extends BaseConfig {
    ...
    inputsMarshal() {
        ...
        const s = {
            ...
            issuerAuthClaimMtp: prepareSiblingsStr(this.claim.signatureProof.issuerAuthIncProof.proof, this.getMTLevel()),
            ...
            issuerAuthRootsTreeRoot: this.claim.signatureProof.issuerAuthIncProof.treeState?.rootOfRoots
                .bigInt()
                .toString(),
            issuerAuthClaimNonRevMtp: prepareSiblingsStr(this.claim.signatureProof.issuerAuthNonRevProof.proof, this.getMTLevel()),
